...
@WebServlet("/api/relatorios/variacao-preco-produto")
public class VariacaoPrecoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            List<VariacaoPrecoItem> lista = dao.variacaoPrecoProduto(usuarioId, produtoId);
            ...
            resp.getWriter().print("{\"erro\": \"usuarioId ou produtoId inválido.\"}");
