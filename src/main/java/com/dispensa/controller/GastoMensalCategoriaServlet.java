...
@WebServlet("/api/relatorios/gasto-mensal-categoria")
public class GastoMensalCategoriaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            List<GastoMensal> lista = dao.gastoMensalPorCategoria(usuarioId, categoriaId);
            ...
            resp.getWriter().print("{\"erro\": \"usuarioId ou categoriaId inválido.\"}");
